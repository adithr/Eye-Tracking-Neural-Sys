...
dep.t.test <- t.test(data$radius_high_stimulus,data$radius_low_stimulus, paired = TRUE)
dep.t.test
#hypothesis 2:
...
#Additional: radius in the heatmap during fixation phase
...
#Hypothesis 1: radius in the heatmap during stimulation phase
dep.t.test.yuen <- yuend(data$radius_high_stimulus, data$radius_low_stimulus)
dep.t.test.yuen
